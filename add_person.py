...
def add_person(name,pictures_path):
	...
	add_person = CF.person.create(config.PERSON_GROUPID,name)
	...
	for picture in picture_list:
		result = CF.person.add_face(picture,config.PERSON_GROUPID,personId)
		print(result)
	CF.person_group.train(config.PERSON_GROUPID) #学習させる
